...
export declare const LatestFirmwareVersionRequired: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const NotEnoughBalanceFees: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const UnstakeNotEnoughStakedBalanceLeft: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const RestakeNotEnoughStakedBalanceLeft: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const NotEnoughToRestake: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const NotEnoughToUnstake: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const NotEnoughToStake: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const MissingSwapPayloadParamaters: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare class DeviceMangementKitError extends Error {
