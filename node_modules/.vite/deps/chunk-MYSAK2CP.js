...
function sqrt3mod4(Fp2, n) {
  const p1div4 = (Fp2.ORDER + _1n) / _4n;
...
function FpLegendre(Fp2, n) {
  const p1mod2 = (Fp2.ORDER - _1n) / _2n;
...
var _0n, _1n, _2n, _3n, _4n, _5n, _7n, _8n, _9n, _16n, isNegativeLE, FIELD_FIELDS;
var init_modular = __esm({
  "node_modules/@noble/curves/esm/abstract/modular.js"() {
    ...
    _9n = BigInt(9);
    _16n = BigInt(16);
    isNegativeLE = (num2, modulo) => (mod(num2, modulo) & _1n) === _1n;
    FIELD_FIELDS = [
      "create",
      "isValid",
      "is0",
...
var _0n2, _1n2, pointPrecomputes, pointWindowSizes, wNAF;
...
function edwards(params, extraOpts = {}) {
  ...
  const MASK = _2n2 << BigInt(Fn2.BYTES * 8) - _1n3;
  ...
  class Point {
    ...
    static fromAffine(p) {
      ...
      acoord("x", x);
      acoord("y", y);
      return new Point(x, y, _1n3, modP(x * y));
    }
    ...
    static fromBytes(bytes, zip215 = false) {
      ...
      aInRange("point.y", y, _0n3, max);
      const y2 = modP(y * y);
      const u = modP(y2 - _1n3);
      const v = modP(d * y2 - a);
  ...
  Point.BASE = new Point(CURVE.Gx, CURVE.Gy, _1n3, modP(CURVE.Gx * CURVE.Gy));
  Point.ZERO = new Point(_0n3, _1n3, _1n3, _0n3);
  Point.Fp = Fp2;
  Point.Fn = Fn2;
...
function eddsa(Point, cHash, eddsaOpts = {}) {
  ...
  const utils = {
    ...
    toMontgomery(publicKey2) {
      ...
      const u = is25519 ? Fp2.div(_1n3 + y, _1n3 - y) : Fp2.div(y - _1n3, y + _1n3);
...
var _0n3, _1n3, _2n2, _8n2, PrimeEdwardsPoint;
...
function map_to_curve_elligator2_curve25519(u) {
  ...
  return { xMn: xn, xMd: xd, yMn: y, yMd: _1n5 };
}
...
var init_ed25519 = __esm({
  "node_modules/@noble/curves/esm/ed25519.js"() {
    ...
    invertSqrt = (number2) => uvRatio(_1n5, number2);
...
var divNearest, DERErr, DER, _0n6, _1n6, _2n5, _3n3, _4n2;
...
function schnorrVerify(signature2, message, publicKey2) {
  ...
  try {
    ...
    if (!inRange(r, _1n7, secp256k1_CURVE.p))
      return false;
    const s = num(sig.subarray(32, 64));
    if (!inRange(s, _1n7, secp256k1_CURVE.n))
      return false;
...
var secp256k1_CURVE, secp256k1_ENDO, _0n7, _1n7, _2n6, Fpk1, secp256k1, TAGGED_HASH_PREFIXES, pointToBytes, Pointk1, hasEven, num, schnorr, isoMap, mapSWU, secp256k1_hasher, hashToCurve2, encodeToCurve2;
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-MYSAK2CP.js.map
