...
import {
  ...
  toHex,
  trim
} from "./chunk-BWA3YIAL.js";
import {
  require_elliptic
} from "./chunk-JQV52EKR.js";
import {
  require_events
} from "./chunk-LYXL6GHH.js";
import {
  init_sha256,
  sha256
} from "./chunk-CK46FWKK.js";
import {
  Chi,
  HashMD,
  Maj,
  init_md
} from "./chunk-5ZKLJFFO.js";
import {
  init_sha3,
  keccak_256
} from "./chunk-OU3VRFUW.js";
import {
  clean,
  createHasher,
  init_utils,
  rotl
} from "./chunk-U3QDKP7S.js";
import {
  __commonJS,
  __esm,
  __export,
    ...
    !function(e3, n5) {
      ...
      return function(e3, n5, t2) {
        t2.updateLocale = function(e4, n6) {
          var o5 = t2.Ls[e4];
          if (o5)
            return (n6 ? Object.keys(n6) : []).forEach(function(e5) {
              o5[e5] = n6[e5];
            }), o5;
        };
      };
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_3)
      try {
        if (f7 = 1, y4 && (t2 = op[0] & 2 ? y4["return"] : op[0] ? y4["throw"] || ((t2 = y4["return"]) && t2.call(y4), 0) : y4.next) && !(t2 = t2.call(y4, op[1])).done)
          return t2;
        if (y4 = 0, t2)
          op = [op[0] & 2, t2.value];
        switch (op[0]) {
...
function __read(o5, n5) {
  ...
  try {
    while ((n5 === void 0 || n5-- > 0) && !(r3 = i5.next()).done)
      ar3.push(r3.value);
  } catch (error) {
    e3 = { error };
  } finally {
    try {
      if (r3 && !r3.done && (m4 = i5["return"]))
        m4.call(i5);
    } finally {
      if (e3)
        throw e3.error;
...
P.cmp = function(y4) {
  ...
  if (!xc[0] || !yc[0])
    return !xc[0] ? !yc[0] ? 0 : -j3 : i5;
  if (i5 != j3)
    return i5;
  isneg = i5 < 0;
  if (k4 != l8)
    return k4 > l8 ^ isneg ? 1 : -1;
  j3 = (k4 = xc.length) < (l8 = yc.length) ? k4 : l8;
  for (i5 = -1; ++i5 < j3; ) {
    if (xc[i5] != yc[i5])
      return xc[i5] > yc[i5] ^ isneg ? 1 : -1;
  }
...
P.div = function(y4) {
  ...
  if (qi2 > p4)
    round(q2, p4, Big2.RM, r3[0] !== UNDEFINED);
  return q2;
};
P.eq = function(y4) {
...
P.minus = P.sub = function(y4) {
  ...
  if ((b4 = (j3 = yc.length) - (i5 = xc.length)) > 0)
    for (; b4--; )
      xc[i5++] = 0;
  for (b4 = i5; j3 > a3; ) {
    if (xc[--j3] < yc[j3]) {
...
P.plus = P.add = function(y4) {
  ...
  e3 = yc.length;
  for (k4 = 0; e3; xc[e3] %= 10)
    k4 = (xc[--e3] = xc[e3] + yc[e3] + k4) / 10 | 0;
  if (k4) {
    xc.unshift(k4);
    ++ye2;
  }
...
P.toFixed = function(dp, rm) {
  ...
  if (dp !== UNDEFINED) {
    ...
    for (dp = dp + x5.e + 1; x5.c.length < dp; )
      x5.c.push(0);
  }
...
var i3 = (r3, e3) => {
  for (var t2 in e3 || (e3 = {}))
    T.call(e3, t2) && f2(r3, t2, e3[t2]);
  if (p)
    for (var t2 of p(e3))
      z.call(e3, t2) && f2(r3, t2, e3[t2]);
  return r3;
};
...
function Cn(t2, e3, n5, r3) {
  if (typeof t2.setBigUint64 == "function")
    return t2.setBigUint64(e3, n5, r3);
...
var An = class extends xn {
  ...
  digestInto(e3) {
    ...
    for (let l8 = 0; l8 < D; l8++)
      u3.setUint32(4 * l8, c7[l8], s4);
  }
  digest() {
...
var Jn = class extends An {
  ...
  process(e3, n5) {
    for (let d5 = 0; d5 < 16; d5++, n5 += 4)
      P3[d5] = e3.getUint32(n5), Q[d5] = e3.getUint32(n5 += 4);
...
function W(t2, e3, n5) {
  ...
  if (typeof n5 == "number" && o5 !== n5)
    throw new Error(t2 + " of length " + n5 + " expected, got " + o5);
  return r3;
}
function ye(...t2) {
  let e3 = 0;
...
function ft(t2, e3, n5, r3) {
  if (!Qn(e3, n5, r3))
    throw new Error("expected valid " + t2 + ": " + n5 + " <= n < " + r3 + ", got " + e3);
}
function tr(t2) {
  let e3;
...
function Ot(t2, e3, n5 = {}) {
  const r3 = (o5, s4, a3) => {
    ...
    const i5 = t2[o5];
    if (!(a3 && i5 === void 0) && !u3(i5, t2))
      throw new Error("param " + String(o5) + " is invalid. Expected " + s4 + ", got " + i5);
  };
  for (const [o5, s4] of Object.entries(e3))
    r3(o5, s4, false);
  for (const [o5, s4] of Object.entries(n5))
    r3(o5, s4, true);
  return t2;
}
function xe(t2) {
...
function or(t2, e3, n5) {
  ...
  let r3 = N;
  for (; e3 > M2; )
    e3 & N && (r3 = r3 * t2 % n5), t2 = t2 * t2 % n5, e3 >>= N;
  return r3;
}
...
function sr(t2) {
  ...
  for (n5 = t2 - N, r3 = 0; n5 % nt === M2; n5 /= nt, r3++)
    ;
  for (o5 = nt; o5 < t2 && or(o5, e3, t2) !== t2 - N; o5++)
    if (o5 > 1e3)
  ...
  return function(u3, i5) {
    if (u3.pow(i5, e3) === u3.neg(u3.ONE))
      throw new Error("Cannot find square root");
    let D = r3, c7 = u3.pow(u3.mul(u3.ONE, o5), n5), l8 = u3.pow(i5, s4), p4 = u3.pow(i5, n5);
    for (; !u3.eql(p4, u3.ONE); ) {
      if (u3.eql(p4, u3.ZERO))
        return u3.ZERO;
      let w4 = 1;
      for (let g4 = u3.sqr(p4); w4 < D && !u3.eql(g4, u3.ONE); w4++)
        g4 = u3.sqr(g4);
...
function fr(t2, e3, n5) {
  ...
  let r3 = t2.ONE, o5 = e3;
  for (; n5 > M2; )
    n5 & N && (r3 = t2.mul(r3, o5)), o5 = t2.sqr(o5), n5 >>= N;
  return r3;
}
function Dr(t2, e3) {
...
function _e(t2, e3, n5 = false, r3 = {}) {
  ...
  const u3 = Object.freeze({ ORDER: t2, isLE: n5, BITS: o5, BYTES: s4, MASK: er(o5), ZERO: M2, ONE: N, create: (i5) => H(i5, t2), isValid: (i5) => {
    ...
    if (i5.length !== s4)
      throw new Error("Field.fromBytes: expected " + s4 + " bytes, got " + i5.length);
...
function lr(t2, e3) {
  return { constTimeNegate: zt, hasPrecomputes(n5) {
    ...
    let s4 = n5;
    for (; r3 > Se; )
      r3 & gt && (o5 = o5.add(s4)), s4 = s4.double(), r3 >>= gt;
    return o5;
    ...
    for (let D = 0; D < o5; D++) {
      i5 = u3, a3.push(i5);
      for (let c7 = 1; c7 < s4; c7++)
        i5 = i5.add(u3), a3.push(i5);
      u3 = i5.double();
    }
    return a3;
  }, wNAF(n5, r3, o5) {
    ...
    for (let l8 = 0; l8 < a3; l8++) {
      ...
      if (o5 === Se)
        break;
      let w4 = Number(o5 & i5);
      if (o5 >>= c7, w4 > u3 && (w4 -= D, o5 += gt), w4 === 0)
        continue;
...
function br(t2, e3, n5, r3) {
  if (dr(n5, t2), hr(r3, e3), n5.length !== r3.length)
  ...
  for (let l8 = D; l8 >= 0; l8 -= a3) {
    ...
    let p4 = o5;
    for (let w4 = i5.length - 1, h6 = o5; w4 > 0; w4--)
      h6 = h6.add(i5[w4]), p4 = p4.add(h6);
    if (c7 = c7.add(p4), l8 !== 0)
      for (let w4 = 0; w4 < a3; w4++)
        c7 = c7.double();
  }
  return c7;
}
...
function Ir(t2, e3) {
  ...
  function l8(h6) {
    ...
    if (h6.length === 0)
      return "";
    for (var g4 = 0, S3 = 0, v5 = 0, L3 = h6.length; v5 !== L3 && h6[v5] === 0; )
      v5++, g4++;
    for (var d5 = (L3 - v5) * c7 + 1 >>> 0, m4 = new Uint8Array(d5); v5 !== L3; ) {
      for (var F3 = h6[v5], q2 = 0, z3 = d5 - 1; (F3 !== 0 || q2 < S3) && z3 !== -1; z3--, q2++)
        F3 += 256 * m4[z3] >>> 0, m4[z3] = F3 % u3 >>> 0, F3 = F3 / u3 >>> 0;
      if (F3 !== 0)
        throw new Error("Non-zero carry");
      S3 = q2, v5++;
    }
    for (var I3 = d5 - S3; I3 !== d5 && m4[I3] === 0; )
      I3++;
    for (var O5 = i5.repeat(g4); I3 < d5; ++I3)
      O5 += t2.charAt(m4[I3]);
    return O5;
  }
  function p4(h6) {
    ...
    if (h6[g4] !== " ") {
      ...
      if (h6[g4] !== " ") {
        for (var z3 = L3 - v5; z3 !== L3 && d5[z3] === 0; )
          z3++;
        for (var I3 = new Uint8Array(S3 + (L3 - z3)), O5 = S3; z3 !== L3; )
          I3[O5++] = d5[z3++];
        return I3;
      }
    }
...
var Or = class {
  constructor(e3, n5, r3) {
    if (this.name = e3, this.prefix = n5, n5.codePointAt(0) === void 0)
...
var qr = (t2, e3, n5) => {
  ...
  for (let i5 = 0; i5 < t2.length; ++i5)
    for (u3 = u3 << 8 | t2[i5], a3 += 8; a3 > n5; )
      a3 -= n5, s4 += e3[o5 & u3 >> a3];
  if (a3 && (s4 += e3[o5 & u3 << n5 - a3]), r3)
    for (; s4.length * n5 & 7; )
      s4 += "=";
  return s4;
};
...
function $e(t2, e3, n5) {
  e3 = e3 || [], n5 = n5 || 0;
  for (var r3 = n5; t2 >= vo; )
    e3[n5++] = t2 & 255 | qe, t2 /= 128;
  for (; t2 & So; )
    e3[n5++] = t2 & 255 | qe, t2 >>>= 7;
...
var te = We("ascii", "a", (t2) => {
  let e3 = "a";
  for (let n5 = 0; n5 < t2.length; n5++)
    e3 += String.fromCharCode(t2[n5]);
  return e3;
}, (t2) => {
  t2 = t2.substring(1);
  const e3 = Le(t2.length);
  for (let n5 = 0; n5 < t2.length; n5++)
    e3[n5] = t2.charCodeAt(n5);
  return e3;
});
...
var __spreadArray = function(to2, from13, pack) {
  if (pack || arguments.length === 2)
    for (var i5 = 0, l8 = from13.length, ar3; i5 < l8; i5++) {
      if (ar3 || !(i5 in from13)) {
        if (!ar3)
          ar3 = Array.prototype.slice.call(from13, 0, i5);
        ar3[i5] = from13[i5];
      }
    }
...
for (let e3 = 0, t2 = Ue2, n5 = 1, r3 = 0; e3 < 24; e3++) {
  ...
  for (let s4 = 0; s4 < 7; s4++)
    t2 = (t2 << Ue2 ^ (t2 >> Lo2) * Co2) % jo2, t2 & Bo2 && (o5 ^= Ue2 << (Ue2 << BigInt(s4)) - Ue2);
  hn.push(o5);
}
...
function Mo2(e3, t2 = 24) {
  ...
  for (let r3 = 24 - t2; r3 < 24; r3++) {
    for (let i5 = 0; i5 < 10; i5++)
      n5[i5] = e3[i5] ^ e3[i5 + 10] ^ e3[i5 + 20] ^ e3[i5 + 30] ^ e3[i5 + 40];
    ...
    for (let i5 = 0; i5 < 50; i5 += 10) {
      for (let c7 = 0; c7 < 10; c7++)
        n5[c7] = e3[i5 + c7];
      for (let c7 = 0; c7 < 10; c7++)
        e3[i5 + c7] ^= ~n5[(c7 + 2) % 10] & n5[(c7 + 4) % 10];
    }
...
var Lt2 = class _Lt extends it2 {
  constructor(t2, n5, r3, o5 = false, s4 = 24) {
    if (super(), this.blockLen = t2, this.suffix = n5, this.outputLen = r3, this.enableXOF = o5, this.rounds = s4, this.pos = 0, this.posOut = 0, this.finished = false, this.destroyed = false, Ne2(r3), 0 >= this.blockLen || this.blockLen >= 200)
...
function kn2(e3, t2, n5, r3) {
  if (typeof e3.setBigUint64 == "function")
    return e3.setBigUint64(t2, n5, r3);
...
function Es(e3, t2, n5, r3, o5, s4, i5, c7) {
  ...
  for (let y4 = 0; y4 < u3; i5++) {
    if (e3(t2, n5, r3, l8, i5, c7), i5 >= Mn2)
    ...
    if (f7 && h6 === Ve2) {
      ...
      for (let L3 = 0, b4; L3 < ws; L3++)
        b4 = m4 + L3, g4[b4] = d5[b4] ^ l8[L3];
      y4 += Ve2;
      continue;
    }
    for (let m4 = 0, L3; m4 < h6; m4++)
      L3 = y4 + m4, s4[L3] = o5[L3] ^ a3[m4];
    y4 += h6;
  }
}
function vs(e3, t2) {
  ...
  return ht2(o5), ht2(i5), jn2(s4), jn2(n5), (c7, u3, a3, l8, f7 = 0) => {
    F(c7), F(u3), F(a3);
    const d5 = a3.length;
    if (l8 === void 0 && (l8 = new Uint8Array(d5)), F(l8), ht2(f7), f7 < 0 || f7 >= Mn2)
      throw new Error("arx: counter overflow");
    if (l8.length < d5)
      throw new Error(`arx: output (${l8.length}) is shorter than data (${d5})`);
    const g4 = [];
    let y4 = c7.length, h6, m4;
    if (y4 === 32)
      g4.push(h6 = gt2(c7)), m4 = bs;
    else if (y4 === 16 && n5)
      h6 = new Uint8Array(32), h6.set(c7), h6.set(c7, 16), m4 = ms, g4.push(h6);
    else
      throw new Error(`arx: invalid 32-byte key, got length=${y4}`);
...
var xs = class {
  ...
  finalize() {
    ...
    let o5 = t2[1] >>> 13;
    t2[1] &= 8191;
    for (let c7 = 2; c7 < 10; c7++)
      t2[c7] += o5, o5 = t2[c7] >>> 13, t2[c7] &= 8191;
    t2[0] += o5 * 5, o5 = t2[0] >>> 13, t2[0] &= 8191, t2[1] += o5, o5 = t2[1] >>> 13, t2[1] &= 8191, t2[2] += o5, r3[0] = t2[0] + 5, o5 = r3[0] >>> 13, r3[0] &= 8191;
    for (let c7 = 1; c7 < 10; c7++)
      r3[c7] = t2[c7] + o5, o5 = r3[c7] >>> 13, r3[c7] &= 8191;
    r3[9] -= 8192;
    let s4 = (o5 ^ 1) - 1;
    for (let c7 = 0; c7 < 10; c7++)
      r3[c7] &= s4;
    ...
    let i5 = t2[0] + n5[0];
    t2[0] = i5 & 65535;
    for (let c7 = 1; c7 < 8; c7++)
      i5 = (t2[c7] + n5[c7] | 0) + (i5 >>> 16) | 0, t2[c7] = i5 & 65535;
    Ee2(r3);
  }
  update(t2) {
    Ln2(this);
...
var js = class extends it2 {
  ...
  digestInto(t2) {
    ...
    if (a3 > l8.length)
      throw new Error("_sha2: outputLen bigger than state");
    for (let f7 = 0; f7 < a3; f7++)
      c7.setUint32(4 * f7, l8[f7], s4);
  }
  digest() {
    const { buffer: t2, outputLen: n5 } = this;
    this.digestInto(t2);
...
var ks = class extends js {
  ...
  process(t2, n5) {
    for (let f7 = 0; f7 < 16; f7++, n5 += 4)
      ce[f7] = t2.getUint32(n5, false);
...
function Zn2(e3, t2, n5) {
  ...
  if (typeof t2 == "string")
    ...
    r3 = Uint8Array.from(t2);
  else
    throw new Error(e3 + " must be hex string or Uint8Array");
  const o5 = r3.length;
  if (typeof n5 == "number" && o5 !== n5)
    throw new Error(e3 + " of length " + n5 + " expected, got " + o5);
  return r3;
}
...
function Qn2(e3, t2, n5, r3) {
  if (!Fs(t2, n5, r3))
    throw new Error("expected valid " + e3 + ": " + n5 + " <= n < " + r3 + ", got " + t2);
}
...
function Gs(e3, t2, n5 = {}) {
  const r3 = (o5, s4, i5) => {
    ...
    if (typeof c7 != "function")
      throw new Error("invalid validator function");
    const u3 = e3[o5];
    if (!(i5 && u3 === void 0) && !c7(u3, e3))
      throw new Error("param " + String(o5) + " is invalid. Expected " + s4 + ", got " + u3);
  };
  for (const [o5, s4] of Object.entries(t2))
    r3(o5, s4, false);
  for (const [o5, s4] of Object.entries(n5))
    r3(o5, s4, true);
  return e3;
...
function Ws(e3, t2, n5) {
  ...
  let r3 = Ke2;
  for (; t2 > ve2; )
    t2 & Ke2 && (r3 = r3 * e3 % n5), e3 = e3 * e3 % n5, t2 >>= Ke2;
  return r3;
}
...
function sr2(r3, e3) {
  ...
  function d5(l8) {
    ...
    if (l8.length === 0)
      return "";
    for (var b4 = 0, x5 = 0, I3 = 0, D = l8.length; I3 !== D && l8[I3] === 0; )
      I3++, b4++;
    for (var j3 = (D - I3) * u3 + 1 >>> 0, T4 = new Uint8Array(j3); I3 !== D; ) {
      for (var q2 = l8[I3], J4 = 0, K4 = j3 - 1; (q2 !== 0 || J4 < x5) && K4 !== -1; K4--, J4++)
        q2 += 256 * T4[K4] >>> 0, T4[K4] = q2 % a3 >>> 0, q2 = q2 / a3 >>> 0;
      if (q2 !== 0)
        throw new Error("Non-zero carry");
      x5 = J4, I3++;
    }
    for (var H2 = j3 - x5; H2 !== j3 && T4[H2] === 0; )
      H2++;
    for (var me3 = c7.repeat(b4); H2 < j3; ++H2)
      me3 += r3.charAt(T4[H2]);
    return me3;
  }
  function g4(l8) {
    ...
    var b4 = 0;
    if (l8[b4] !== " ") {
      for (var x5 = 0, I3 = 0; l8[b4] === c7; )
        x5++, b4++;
      for (var D = (l8.length - b4) * h6 + 1 >>> 0, j3 = new Uint8Array(D); l8[b4]; ) {
        var T4 = t2[l8.charCodeAt(b4)];
        if (T4 === 255)
          return;
        for (var q2 = 0, J4 = D - 1; (T4 !== 0 || q2 < I3) && J4 !== -1; J4--, q2++)
          T4 += a3 * j3[J4] >>> 0, j3[J4] = T4 % 256 >>> 0, T4 = T4 / 256 >>> 0;
        if (T4 !== 0)
          throw new Error("Non-zero carry");
        I3 = q2, b4++;
      }
      if (l8[b4] !== " ") {
        for (var K4 = D - I3; K4 !== D && j3[K4] === 0; )
          K4++;
        for (var H2 = new Uint8Array(x5 + (D - K4)), me3 = x5; K4 !== D; )
          H2[me3++] = j3[K4++];
        return H2;
      }
    }
...
var gr2 = (r3, e3, t2) => {
  ...
  for (let c7 = 0; c7 < r3.length; ++c7)
    for (a3 = a3 << 8 | r3[c7], o5 += 8; o5 > t2; )
      o5 -= t2, n5 += e3[i5 & a3 >> o5];
  if (o5 && (n5 += e3[i5 & a3 << t2 - o5]), s4)
    for (; n5.length * t2 & 7; )
      n5 += "=";
  return n5;
};
...
function ai2(r3, e3, t2) {
  e3 = e3 || [], t2 = t2 || 0;
  for (var s4 = t2; r3 >= tn; )
    e3[t2++] = r3 & 255 | oi2, r3 /= 128;
  for (; r3 & en2; )
    e3[t2++] = r3 & 255 | oi2, r3 >>>= 7;
...
var Be2 = mi2("ascii", "a", (r3) => {
  ...
  for (let t2 = 0; t2 < r3.length; t2++)
    e3 += String.fromCharCode(r3[t2]);
  return e3;
}, (r3) => {
  r3 = r3.substring(1);
  const e3 = Tn2(r3.length);
  for (let t2 = 0; t2 < r3.length; t2++)
    e3[t2] = r3.charCodeAt(t2);
  return e3;
});
...
var p3 = (r3, t2) => {
  for (var e3 in t2 || (t2 = {}))
    L2.call(t2, e3) && l7(r3, e3, t2[e3]);
  if (c6)
    for (var e3 of c6(t2))
      O4.call(t2, e3) && l7(r3, e3, t2[e3]);
  return r3;
};
      ...
      return (this.events.listenerCount("register_error") >= e3 || this.events.listenerCount("open") >= e3) && this.events.setMaxListeners(e3 + 1), new Promise((s4, i5) => {
        this.events.once("register_error", (n5) => {
          ...
          if (this.resetMaxListeners(), typeof this.isAvailable > "u")
            return i5(new Error("HTTP connection is missing or invalid"));
          s4();
        });
      });
    }
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-FGS5FXER.js.map
