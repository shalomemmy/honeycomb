...
var ICONS = {
  add: async () => (await import("./add-GN5IUCPT.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-PIHHGOKO.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-HGB5OLOP.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-F5FDTDYF.js")).appStoreSvg,
  apple: async () => (await import("./apple-5QSMWUUA.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-ENLGVTYY.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-FRR5VN2R.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-7X37OHYV.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-WGBKXI2A.js")).arrowTopSvg,
  bank: async () => (await import("./bank-Z2WLE5I3.js")).bankSvg,
  browser: async () => (await import("./browser-4HGRSE4U.js")).browserSvg,
  card: async () => (await import("./card-Q3ZPI6JV.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-QK5EYSH3.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-YRZSKY76.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-DM6S4QIM.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-GWKTIL2H.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-MFLODYLB.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-TNKK4RSM.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-JIM4OV7W.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-FK6UILZC.js")).clockSvg,
  close: async () => (await import("./close-WFASTCKW.js")).closeSvg,
  compass: async () => (await import("./compass-HE4GYPTU.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ZXF3CLWU.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-3HVERLUK.js")).copySvg,
  cursor: async () => (await import("./cursor-MQA7RARM.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-TBJYGBML.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-N4QPMLJR.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-ML5YIHW7.js")).disconnectSvg,
  discord: async () => (await import("./discord-5TN7ZR4K.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-U3RNEDD5.js")).etherscanSvg,
  extension: async () => (await import("./extension-BRXAONRX.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-XVI6QLC7.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-TXBJR7MI.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-ESOQN6OQ.js")).farcasterSvg,
  filters: async () => (await import("./filters-OEOZOSMQ.js")).filtersSvg,
  github: async () => (await import("./github-BZYQFBAA.js")).githubSvg,
  google: async () => (await import("./google-OFHDWNBO.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-42FJTZB3.js")).helpCircleSvg,
  image: async () => (await import("./image-EBDPHVSS.js")).imageSvg,
  id: async () => (await import("./id-SPIR5KU4.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-EJUFNGBC.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-J34WXKFV.js")).lightbulbSvg,
  mail: async () => (await import("./mail-FSPDUB5D.js")).mailSvg,
  mobile: async () => (await import("./mobile-QV5MMOU3.js")).mobileSvg,
  more: async () => (await import("./more-7SSEXTGE.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-NSKGHY33.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-7Q32I6DR.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-RPSF6KYJ.js")).offSvg,
  playStore: async () => (await import("./play-store-GY5CUOQG.js")).playStoreSvg,
  plus: async () => (await import("./plus-KINC4LBE.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-AGGSDKOY.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-G6T3AGMR.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-6PFYORVU.js")).refreshSvg,
  search: async () => (await import("./search-2BMOF2W2.js")).searchSvg,
  send: async () => (await import("./send-NLIHCVRT.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-D5M4KGNZ.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-B4365NOI.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-QAWT2P4C.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-MWZQEW3C.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-QKUG3363.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-YO4VCKO5.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-VCQ5TPV3.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-P4FU47YE.js")).twitchSvg,
  twitter: async () => (await import("./x-RKABZFDZ.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-VH3LYDXN.js")).twitterIconSvg,
  verify: async () => (await import("./verify-V5URCRJD.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-5WV5GIUY.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-7GC5VSTK.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-4GGQD6CC.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-4GGQD6CC.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-4GGQD6CC.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-KF3OB2VU.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-O3LYJ2QW.js")).warningCircleSvg,
  x: async () => (await import("./x-RKABZFDZ.js")).xSvg,
  info: async () => (await import("./info-CWL5IW3F.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-2J3ULU4M.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-AVLUOU7C.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OCLQ2ZAP.js.map
